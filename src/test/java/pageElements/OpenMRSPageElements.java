...
public class OpenMRSPageElements {
	...
	public By givenName = By.id("fr1713-field");
	public By familyName = By.id("fr9659-field");
	...
	public By phoneNumberField = By.id("fr8104-field");
	...
	public By confirmName = By.xpath("//span[text()='Name: ']");
	public By confirmGender = By.xpath("//span[text()='Gender: ']");
	public By confirmBirthdate = By.xpath("//span[text()='Birthdate: ']");
	public By confirmAddress = By.xpath("//span[text()='Adress: ']");
	public By confirmPhoneNumber = By.xpath("//span[text()='Phone Number: ']");
	...
	public By toasterMessage = By.xpath("//*[contains(@class,'dz-hidden-input') and contains(text(), 'successfully')]");
	...
	public By confirmEndVisit = By.className("confirm right");
